...
public class StatsActivity extends AppCompatActivity {
    ...
    private void generatePieChart(List<MoodEvent> events, String centerText) {
        ...
        // Build slice labels with emoticons (ensure getEmoticonResource returns a valid string resource)
    ...
    private void spinTheChart() {
        ...
        // Compute end angle: 3 full rotations + a random extra angle
        float endAngle = startAngle + 360f * 10 + new Random().nextInt(360);
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                // After spinning, randomly highlight one slice.
